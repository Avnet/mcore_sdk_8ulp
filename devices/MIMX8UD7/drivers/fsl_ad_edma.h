 ...
 */
void EDMA_Init(DMA_AD_Type *base, const edma_config_t *config);
 ...
 * @param base eDMA peripheral base address.
 */
void EDMA_Deinit(DMA_AD_Type *base);
 ...
 */
void EDMA_InstallTCD(DMA_AD_Type *base, uint32_t channel, edma_tcd_t *tcd);
 ...
 */
static inline void EDMA_EnableAllChannelLink(DMA_AD_Type *base, bool enable)
{
    if (enable)
    {
 ...
 */
void EDMA_ResetChannel(DMA_AD_Type *base, uint32_t channel);
 ...
 */
void EDMA_SetTransferConfig(DMA_AD_Type *base,
                            uint32_t channel,
 ...
 */
void EDMA_SetMinorOffsetConfig(DMA_AD_Type *base, uint32_t channel, const edma_minor_offset_config_t *config);
 ...
 */
static inline void EDMA_SetChannelArbitrationGroup(DMA_AD_Type *base, uint32_t channel, uint32_t group)
{
 ...
 */
static inline void EDMA_SetChannelPreemptionConfig(DMA_AD_Type *base,
                                                   uint32_t channel,
 ...
 */
static inline uint32_t EDMA_GetChannelSystemBusInformation(DMA_AD_Type *base, uint32_t channel)
{
 ...
 */
void EDMA_SetChannelLink(DMA_AD_Type *base, uint32_t channel, edma_channel_link_type_t type, uint32_t linkedChannel);
 ...
 */
void EDMA_SetBandWidth(DMA_AD_Type *base, uint32_t channel, edma_bandwidth_t bandWidth);
 ...
 */
void EDMA_SetModulo(DMA_AD_Type *base, uint32_t channel, edma_modulo_t srcModulo, edma_modulo_t destModulo);
 ...
 */
static inline void EDMA_EnableAsyncRequest(DMA_AD_Type *base, uint32_t channel, bool enable)
{
    assert(channel < (uint32_t)FSL_FEATURE_EDMA_MODULE_CHANNEL);
 ...
 * @param enable The command to enable (true) or disable (false).
 */
static inline void EDMA_EnableAutoStopRequest(DMA_AD_Type *base, uint32_t channel, bool enable)
{
    assert(channel < (uint32_t)FSL_FEATURE_EDMA_MODULE_CHANNEL);
 ...
 */
void EDMA_EnableChannelInterrupts(DMA_AD_Type *base, uint32_t channel, uint32_t mask);
 ...
 *             the defined edma_interrupt_enable_t type.
 */
void EDMA_DisableChannelInterrupts(DMA_AD_Type *base, uint32_t channel, uint32_t mask);
 ...
 */
static inline void EDMA_SetChannelMux(DMA_AD_Type *base, uint32_t channel, uint32_t mux)
{
    assert(channel < (uint32_t)FSL_FEATURE_EDMA_MODULE_CHANNEL);
 ...
 * @param channel eDMA channel number.
 */
static inline void EDMA_EnableChannelRequest(DMA_AD_Type *base, uint32_t channel)
{
    assert(channel < (uint32_t)FSL_FEATURE_EDMA_MODULE_CHANNEL);
 ...
 * @param channel eDMA channel number.
 */
static inline void EDMA_DisableChannelRequest(DMA_AD_Type *base, uint32_t channel)
{
    assert(channel < (uint32_t)FSL_FEATURE_EDMA_MODULE_CHANNEL);
 ...
 * @param channel eDMA channel number.
 */
static inline void EDMA_TriggerChannelStart(DMA_AD_Type *base, uint32_t channel)
{
    assert(channel < (uint32_t)FSL_FEATURE_EDMA_MODULE_CHANNEL);
 ...
 */
uint32_t EDMA_GetRemainingMajorLoopCount(DMA_AD_Type *base, uint32_t channel);
 ...
 */
static inline uint32_t EDMA_GetErrorStatusFlags(DMA_AD_Type *base)
{
    return base->MP_ES;
}
 ...
 */
uint32_t EDMA_GetChannelStatusFlags(DMA_AD_Type *base, uint32_t channel);
 ...
 */
void EDMA_ClearChannelStatusFlags(DMA_AD_Type *base, uint32_t channel, uint32_t mask);
 ...
 * @param channel eDMA channel number.
 */
void EDMA_CreateHandle(edma_handle_t *handle, DMA_AD_Type *base, uint32_t channel);
