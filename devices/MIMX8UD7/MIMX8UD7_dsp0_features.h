...
#define FSL_FEATURE_SOC_SFA_COUNT (3)
...
/* @brief MU Has no register CSSR0. */
#define FSL_FEATURE_MU_NO_CORE_STATUS (0)
/* @brief MU does not support NMI, CCR0[NMI]. */
#define FSL_FEATURE_MU_NO_NMI (0)
/* @brief MU does not support hold the other core reset. CCR0[RSTH]. */
#define FSL_FEATURE_MU_NO_RSTH (0)
/* @brief MU does not support hold the other core reset. CCR0[BOOT]. */
