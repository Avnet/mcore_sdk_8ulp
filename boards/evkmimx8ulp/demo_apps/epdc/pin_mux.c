...
- pin_list:
  - {pin_num: AJ4, peripheral: LPUART0, signal: lpuart_rx, pin_signal: PTA19, PS: UP, PE: ENABLED}
  - {pin_num: AF6, peripheral: LPUART0, signal: lpuart_tx, pin_signal: PTA18, PS: UP, PE: ENABLED}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
